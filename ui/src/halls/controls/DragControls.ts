...
export class DragControls {
  ...
  endDrag(): { position: ProjectPosition; startPosition: ProjectPosition } | null {
    ...
    if (this.gridEnabled) {
      stationPos.x = Math.round(stationPos.x / this.options.gridSize) * this.options.gridSize;
      stationPos.z = Math.round(stationPos.z / this.options.gridSize) * this.options.gridSize;
    }
  ...
  cancelDrag() {
    ...
    if (this.dragStartPosition) {
      station
        .getMesh()
        .position.set(this.dragStartPosition.x, this.dragStartPosition.y, this.dragStartPosition.z);
