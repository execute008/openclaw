...
export class VRWristMenu {
  ...
  constructor(options: VRWristMenuOptions) {
    ...
    this.controllerAnchors = [this.renderer.xr.getController(0), this.renderer.xr.getController(1)];
    this.handAnchors = [this.renderer.xr.getHand(0), this.renderer.xr.getHand(1)];
