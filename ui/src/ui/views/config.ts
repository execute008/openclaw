...
import type { ConfigUiHints, NotionDatabasesResult } from "../types.ts";
...
const sidebarIcons = {
  ...
  integrations: html`
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      <path d="M10 13a5 5 0 0 0 7.54.54l2.5-2.5a5 5 0 0 0-7.07-7.07L10.5 4.5"></path>
      <path d="M14 11a5 5 0 0 0-7.54-.54l-2.5 2.5a5 5 0 0 0 7.07 7.07L13.5 19.5"></path>
    </svg>
  `,
  skills: html`
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
function formatNotionDatabaseLabel(entry: { id: string; title?: string | null }): string {
