...
const FIELD_LABELS: Record<string, string> = {
  ...
  "integrations.notion.enabled": "Enable Notion",
  "integrations.notion.apiKey": "Notion API Key",
  "integrations.notion.databaseId": "Notion Database ID",
  "integrations.notion.timeoutSeconds": "Notion Timeout (sec)",
  "integrations.notion.propertyMap": "Notion Property Map",
  "integrations.notion.propertyMap.name": "Notion Name Property",
  "integrations.notion.propertyMap.status": "Notion Status Property",
  "integrations.notion.propertyMap.type": "Notion Type Property",
  "integrations.notion.propertyMap.client": "Notion Client Property",
  "integrations.notion.propertyMap.deadline": "Notion Deadline Property",
  "integrations.notion.propertyMap.revenue": "Notion Revenue Property",
  "integrations.notion.propertyMap.impact": "Notion Impact Property",
  "integrations.notion.propertyMap.techStack": "Notion Tech Stack Property",
  "integrations.notion.propertyMap.description": "Notion Description Property",
  "integrations.notion.propertyMap.customColor": "Notion Color Property",
  "integrations.notion.propertyMap.icon": "Notion Icon Property",
  "integrations.notion.propertyMap.size": "Notion Size Property",
...
const FIELD_HELP: Record<string, string> = {
  ...
  "integrations.notion.enabled": "Enable Notion project sync (default: false).",
  "integrations.notion.apiKey": "Notion integration API key.",
  "integrations.notion.databaseId": "Notion database ID containing project records.",
  "integrations.notion.timeoutSeconds": "Timeout in seconds for Notion API requests.",
  "integrations.notion.propertyMap": "Override Notion property names for project fields.",
  "integrations.notion.propertyMap.name": "Title property used for the project name.",
  "integrations.notion.propertyMap.status": "Status/select property used for project status.",
  "integrations.notion.propertyMap.type": "Select property used for project type.",
  "integrations.notion.propertyMap.client": "Text/select property used for client name.",
  "integrations.notion.propertyMap.deadline": "Date property used for project deadline.",
  "integrations.notion.propertyMap.revenue": "Number property used for project revenue.",
  "integrations.notion.propertyMap.impact": "Text/number property used for project impact.",
  "integrations.notion.propertyMap.techStack": "Multi-select property used for tech stack.",
  "integrations.notion.propertyMap.description": "Text property used for project description.",
  "integrations.notion.propertyMap.customColor": "Text/select property used for project color.",
  "integrations.notion.propertyMap.icon": "Text property used for project icon.",
  "integrations.notion.propertyMap.size": "Select/text property used for project size.",
};
...
const FIELD_PLACEHOLDERS: Record<string, string> = {
  ...
  "integrations.notion.databaseId": "abcdef12-3456-7890-abcd-ef1234567890",
  "integrations.notion.propertyMap.name": "Name",
  "integrations.notion.propertyMap.status": "Status",
  "integrations.notion.propertyMap.type": "Type",
};
